...
use TravelPortModule\Air\AirSearchReqType\JourneyDataAType;
use TravelPortModule\Common\BaseSearchReqType;
use TravelPortModule\XsdTransfer\OutOfRangeException;

/**
 * Base Request for Air Search
 * XSD Type: AirSearchReq
 */
class AirSearchReqType extends BaseSearchReqType
{
	...
	/**
	 * @anonymous @var \TravelPortModule\Air\AirSearchReqType\JourneyDataAType AnonymousType
	 * @xsdns TravelPortModule\Air
	 */
