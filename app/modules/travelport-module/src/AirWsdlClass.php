<?php
/**
 * File for AirWsdlClass to communicate with SOAP service
 * @package Air
 * @date 2014-12-09
 * @author Pavel Paulík
 * @version 1
 */
/**
 * AirWsdlClass to communicate with SOAP service
 * 
 * @package Air
 * @date 2014-12-09
 * @author Pavel Paulík
 * @version 1
 */
class AirWsdlClass extends \Nette\Object implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'c:\\wamp\\www\\superletuska.cz\\www\\galileo\\air_v29_0/Air.wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses AirWsdlClass::setLastError()
     * @uses AirWsdlClass::initSoapClient()
     * @uses AirWsdlClass::initInternArrayToIterate()
     * @uses AirWsdlClass::_set()
     ...
     * @return AirWsdlClass
     */
    public function __construct($_arrayOfValues = array(),$_resetSoapClient = true, $_nonWSDLMode = false)
    {
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'AirWsdlClass'))
            {
     ...
     * @uses AirClassMap::classMap()
     * @uses AirWsdlClass::getDefaultWsdlOptions()
     * @uses AirWsdlClass::getSoapClientClassName()
     * @uses AirWsdlClass::setSoapClient()
        ...
        if(class_exists('AirClassMap',true))
        {
            ...
            if(array_key_exists(str_replace('wsdl_','',self::WSDL_URL),$wsdlOptions))
            {
                ...
                if ($_nonWSDLMode) {
                    ...
                    self::setSoapClient(new $soapClientClassName(null, $wsdlOptions));
                }
            }
        }
    }
     ...
     * If a class is named as {Air}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('AirSoapClient') && is_subclass_of('AirSoapClient','SoapClient'))
            return 'AirSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses AirWsdlClass::WSDL_CACHE_WSDL
     * @uses AirWsdlClass::WSDL_COMPRESSION
     * @uses AirWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses AirWsdlClass::WSDL_ENCODING
     * @uses AirWsdlClass::WSDL_EXCEPTIONS
     * @uses AirWsdlClass::WSDL_FEATURES
     * @uses AirWsdlClass::WSDL_LOGIN
     * @uses AirWsdlClass::WSDL_PASSWORD
     * @uses AirWsdlClass::WSDL_SOAP_VERSION
     * @uses AirWsdlClass::WSDL_STREAM_CONTEXT
     * @uses AirWsdlClass::WSDL_TRACE
     * @uses AirWsdlClass::WSDL_TYPEMAP
     * @uses AirWsdlClass::WSDL_URL
     * @uses AirWsdlClass::VALUE_WSDL_URL
     * @uses AirWsdlClass::WSDL_USER_AGENT
     * @uses AirWsdlClass::WSDL_PROXY_HOST
     * @uses AirWsdlClass::WSDL_PROXY_PORT
     * @uses AirWsdlClass::WSDL_PROXY_LOGIN
     * @uses AirWsdlClass::WSDL_PROXY_PASSWORD
     * @uses AirWsdlClass::WSDL_LOCAL_CERT
     * @uses AirWsdlClass::WSDL_PASSPHRASE
     * @uses AirWsdlClass::WSDL_AUTHENTICATION
     * @uses AirWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses AirWsdlClass::getSoapClient()
     ...
     * @uses AirWsdlClass::getSoapClient()
     * @uses AirWsdlClass::getFormatedXml()
     ...
     * @uses AirWsdlClass::getSoapClient()
     * @uses AirWsdlClass::convertStringHeadersToArray()
     ...
     * @uses AirWsdlClass::getInternArrayToIterate()
     * @uses AirWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses AirWsdlClass::getInternArrayToIterateOffset()
     * @uses AirWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses AirWsdlClass::getInternArrayToIterateOffset()
     * @uses AirWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses AirWsdlClass::getAttributeName()
     * @uses AirWsdlClass::__toString()
     * @uses AirWsdlClass::_set()
     * @uses AirWsdlClass::_get()
     * @uses AirWsdlClass::setInternArrayToIterate()
     * @uses AirWsdlClass::setInternArrayToIterateIsArray()
     * @uses AirWsdlClass::setInternArrayToIterateOffset()
